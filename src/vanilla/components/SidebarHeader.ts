        ...
        this.element.innerHTML = `
            ...
            <div style="display: flex; align-items: center; gap: 4px">
                <button id="btn-history" title="Past conversations [CTRL+ALT+H]" class="header-btn" style="gap: 6px; padding: 4px 8px">
                    <span class="top-accent-text" style="font-size: 10px; color: var(--agent-text-muted)">History <code class="terminal-shortcut-hint" style="font-size: 8px">[ALT+H]</code></span>
                    ${HistoryIcon(14)}
                </button>
                <button id="btn-tools" title="Agent Tools & Skills [CTRL+ALT+T]" class="header-btn" style="gap: 6px; padding: 4px 8px">
                    <span class="top-accent-text" style="font-size: 10px; color: var(--agent-text-muted)">Tools <code class="terminal-shortcut-hint" style="font-size: 8px">[ALT+T]</code></span>
                    ${HammerIcon(14)}
                </button>
                <button id="btn-mcp" title="MCP [CTRL+ALT+M]" class="header-btn" style="gap: 6px; padding: 4px 8px">
                    <span class="top-accent-text" style="font-size: 10px; color: var(--agent-text-muted)">MCP <code class="terminal-shortcut-hint" style="font-size: 8px">[ALT+M]</code></span>
                    ${MCPIcon(14)}
                </button>
                <button id="btn-system" title="System Information [CTRL+ALT+I]" class="header-btn" style="gap: 6px; padding: 4px 8px">
                    <span class="top-accent-text" style="font-size: 10px; color: var(--agent-text-muted)">System <code class="terminal-shortcut-hint" style="font-size: 8px">[ALT+I]</code></span>
                    ${EllipsisIcon(14)}
                </button>
